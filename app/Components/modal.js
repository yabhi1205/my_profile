        ...
        <>
            {hidden &&
                // <div className=" h-full w-full overflow-hidden relative">
                    <div id="staticModal" data-modal-backdrop="static" tabindex="-1" aria-hidden="true" className="fixed  top-0 left-0 right-0 z-50 w-screen p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] ">
                        <div className=" m-auto mt-8 mb-12 w-full max-w-2xl max-h-full">
                            <div className=" bg-white w-full rounded-lg shadow dark:bg-gray-700">
                                {/* <div className=" w-6/12 h-12"> */}
                                    <div className="flex bg-white dark:bg-gray-700  items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                                ...
                                <div className="p-6 space-y-6">
                                    ...
                                    <ul className="list-disc ml-6 text-base leading-relaxed text-gray-500 dark:text-gray-400">
                                        {project.description.points.map((points) => {
                                            return (
                                                <li><strong>{points.title}</strong>:{points.desc}</li>
                                            )
                                        })}
                                    </ul>
                                </div>
